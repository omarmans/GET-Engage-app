...
export class MerchantService {
  ...
  private ass =
    'http://10.3.21.25:8109/api/app/voucher/assign-mershant-to-voucher-details';
  private apidetails =
    'http://10.3.21.25:8109/api/app/mercant/merchant-by-name';
  ...
  assigndata(data: any): Observable<any> {
    return this.http.post<any>(
      `http://10.3.21.25:8109/api/app/voucher/assign-mershant-to-voucher-details?voucherId=${data.voucherId}&number=${data.number}&merchantId=${data.merchantId}`,
      data
    );
  }
}
